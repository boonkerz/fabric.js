...
fabric.util.object.extend(fabric.IText.prototype, /** @lends fabric.IText.prototype */ {
  ...
  _setSVGTextLineChars: function(textLine, lineIndex, textSpans, lineHeight, lineTopOffsetMultiplier, textBgRects) {
    /*
      if(!this._fixFirstLine) {
          this._fixFirstLine = this._getSVGLineTopOffset(lineIndex);
          if(this._fixFirstLine < 0) {
              this._fixFirstLine = this._fixFirstLine*-1;
          }
      }
*/
    var yProp = lineIndex === 0 || this.useNative ? 'y' : 'dy',
        ...
        topOffset = this._getSVGLineTopOffset(lineIndex) - this._fixFirstLine;
    ...
    for (var i = 0, len = chars.length; i < len; i++) {
      ...
      textSpans.push(
        this._createTextCharSpan(
          chars[i], styleDecl, lineLeftOffset, topOffset, yProp, charOffset));
      ...
      if (styleDecl.textBackgroundColor) {
        textBgRects.push(
          this._createTextCharBg(
            styleDecl, lineLeftOffset, this.svgLineTopOffset, heightOfLine, charWidth, charOffset));
      }
  ...
  _getSVGLineLeftOffset: function(lineIndex) {
    return (this._boundariesRaw && this._boundariesRaw[lineIndex])
      ? fabric.util.toFixed(this._boundariesRaw[lineIndex].left, 2)
      : 0;
  },
